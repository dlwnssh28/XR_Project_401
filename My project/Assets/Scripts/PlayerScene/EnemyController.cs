...
public class EnemyController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        player = GameObject.FindGameObjectWithTag("Player").transform;          //Player Tag 를 가지고 있는 오브젝트 transfrom 을 입력
    }
    ...
    void Update()
    {
        if(player != null)
        {
            ...
            Vector3 targetDirection = (player.position - EnemyPivot.transform.position).normalized; //포탑의 방향을 계산
